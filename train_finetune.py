...
with strategy.scope():
    ...
    F.load_weights(os.path.join(WEIGHT_DIR, f"F_{X_DIM}x{X_DIM}_weights_50.h5"))
    G.load_weights(os.path.join(WEIGHT_DIR, f"G_{X_DIM}x{X_DIM}_weights_50.h5"))
    E.load_weights(os.path.join(WEIGHT_DIR, f"E_{X_DIM}x{X_DIM}_weights_50.h5"))
    D.load_weights(os.path.join(WEIGHT_DIR, f"D_{X_DIM}x{X_DIM}_weights_50.h5"))
...
print("fine-tuning straight model")
